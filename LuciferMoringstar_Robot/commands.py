...
async def start_message(bot, message):
    ...
    if len(message.command) != 2:
        ...
        await message.reply_video(video = choice(BOT_PICS), caption=START_MSG.format(mention = message.from_user.mention, bot_name = bot_info.BOT_NAME, bot_username = bot_info.BOT_USERNAME), reply_markup=InlineKeyboardMarkup(buttons))
